<template>      
  <ion-page>
    <ion-content :fullscreen="true"> 
      ...
      <div v-else  class="px-3 mt-3" style="height:89vh;">
        <Fieldset class="shadow" style="border:none !important; height: 96%;" :pt="{legend:{style:'border:none !important'}}">     
          <template #legend>
            <div class="d-flex align-items-center justify-content-between">
              <h5 class="text-center mb-0 text-secondary badge text-center p-0">NiCare Enrolee Encounter Tracking Form</h5>
            ...
            <p class="row w-100 mx-auto" >        
              ...
              <div v-show="showfields && enrolee.nicare_id !=''" class="col-12 mb-2">    
                  <div class="w-100">
                      ...
                      <Dropdown filter :class="{'p-invalid':required.reason_of_visit}" v-model="enrolee.reason_of_visit" :options="services" optionLabel="case_name" optionValue="id" placeholder="Select Reason For Visit" class="w-100" />                
                      <small class="d-none" id="reason_of_visit-help">Enter your Reason of Visit</small>
                  </div>
              </div>
              <div v-show="showfields && enrolee.nicare_id !=''" class="col-12 mb-2">    
                  <div class="w-100">
              ...
              <center>
                <Button v-show="showfields && enrolee.nicare_id !=''" @click="addRecord"  class="mt-3" :disabled="!(enrolee.date_of_visit && enrolee.reason_of_visit && enrolee.reporting_month)" label="Fetch Data" />
              </center> 
            </p>            
...
import { IonContent,IonCardContent,IonRefresher,
          IonRefresherContent, IonHeader, IonPage, IonTitle, IonToolbar,IonCard, toastController} from '@ionic/vue';
export default {
  components:{
    IonPage,
    IonContent,
