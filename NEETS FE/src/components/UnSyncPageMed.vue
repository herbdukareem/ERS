<template>
    <ion-page>
      <ion-content>
        <div class="w-100">
              <button
              class="btn btn-primary d-block w-75 mx-auto mt-2 text-md mx-auto"
        ...
        <div class="px-4 rounded" style="overflow-x:auto;">        
          <div>
            <table class="table table-condensed mt-3" style="min-width:500px;">
              <thead>
                  <tr>
                      <th>S/N</th>
                      <th>Nicare ID</th>
